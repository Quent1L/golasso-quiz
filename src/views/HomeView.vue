<template>
  <div class="min-h-screen bg-primary">
    ...
    <div class="px-6 pt-12 pb-8 text-center">
      ...
      />
      <h1 class="text-3xl font-bold text-primary mb-2">Golasso</h1>
      <p class="text-secondary">Testez votre culture football</p>
    </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6">
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          <div class="text-center">
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400">Moyenne</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold text-green-600">
          ...
          >
            <div>
              <div class="font-medium text-gray-900 dark:text-white">
                {{ quiz.type === "classic" ? "QCM" : "Classement" }}
              </div>
